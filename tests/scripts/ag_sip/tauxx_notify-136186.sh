...
COUNT=1
sudo $SIPP_PATH/sipp $TAUIP:$TAUPORT -sf $SRC_PATH/notify-136186.xml -inf $SRC_PATH/notify-136186.csv -mi $SIPPIP -m 1 -nd -i $SIPPIP -p $SIPPORT -rtp_echo -recv_timeout 200s -timeout_error &
REZULT
sleep 2
